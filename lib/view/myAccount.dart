...
class _myPageState extends State<myPage> {
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                            fit: BoxFit.fill,
                            image:
                                documentSnapshot.data()['profile_image'] == '-1'
  ...
  List<Widget> _buildGridMenu() {
    List<myAccountMenu> _menus = [
      myAccountMenu(menuName: '전체 거래 내역', iconData: Icons.note_outlined),
      myAccountMenu(
          menuName: '나의 거래 게시글', iconData: Icons.account_box_outlined),
      myAccountMenu(
          menuName: 'MY MARKET', iconData: Icons.shopping_cart_outlined),
      myAccountMenu(menuName: '냉장고 관리', iconData: Icons.kitchen_outlined),
      myAccountMenu(
          menuName: '나의 영양 정보 관리', iconData: Icons.fact_check_outlined),
      myAccountMenu(menuName: '알림 관리', iconData: Icons.notifications_none),
      myAccountMenu(menuName: '앱 설정', iconData: Icons.settings),
    ];
          ...
          children: [
            Container(
              ...
              child: IconButton(
                ...
                onPressed: () =>
                    print(Navigator.pushNamed(context, APPSETTINGS)),
              ),
            ),
            Container(
              padding:
...
class myAccountMenu {
  ...
  myAccountMenu({this.menuName, this.iconData});
}
